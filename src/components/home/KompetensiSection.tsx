    ...
    <section className="kompetensi-section" id="kompetensi">
      <div className="container">
        ...
        <div className="matrix-tabs">
          <a className="matrix-tab" href="#kompetensi-list" data-target="kompetensi-list">
          ...
          <a className="matrix-tab" href="#cpl-list" data-target="cpl-list">
            <svg className="svg-icon-inline" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="matrix-content-wrapper">
          <div className="matrix-panel" id="kompetensi-list">
          ...
          <div className="matrix-panel" id="cpl-list">
