...
const STATIC_ITEMS: CommandItem[] = [
  ...
  { title: 'Prospek Karir Lulusan', cat: 'Karir', url: '#karir' },
  { title: 'Kurikulum Terintegrasi', cat: 'Kurikulum', url: '/integrated-curr' },
  { title: 'Peta Alur & Prasyarat Mata Kuliah', cat: 'Kurikulum', url: '/prasyarat-linkmap' },
